...
## 🔒 About My Public Work

Most of the large-scale systems I build are developed within private
company repositories and cannot be shared publicly due to NDA constraints.

This GitHub profile focuses on:
- Research artifacts and publications
- Architecture- and system-level documentation
- Reference implementations and demos where possible

Additional public engineering material will be added progressively.
